<template>
  <section
    ref="heroRef"
    class="relative h-screen flex items-center justify-center overflow-x-clip bg-dark"
  >
    <!-- Background image -->
    <div class="absolute inset-0">
      ...
      />
      <div
        class="absolute inset-0 bg-gradient-to-b from-dark/40 via-dark/20 to-dark/90"
      />
    </div>
...
onMounted(() => {
  if (musicEnabled.value) {
    ...
    window.addEventListener("wheel", onFirstScroll, {
      once: true,
      passive: true,
    });
    window.addEventListener("touchmove", onFirstScroll, {
      once: true,
      passive: true,
    });
  }
