<template>
  ...
  >
    ...
    <div class="text-center py-28 md:py-36 px-6">
      <p
        class="map-script font-sans text-xs md:text-sm uppercase tracking-[0.4em] text-gold/60 mb-4 will-change-transform"
        :class="{ 'font-khmer! text-sm! tracking-normal!': locale === 'kh' }"
      >
        {{ t("venue.subtitle") }}
      </p>
      <h2
        class="map-title font-display text-5xl md:text-7xl text-warm-white font-semibold will-change-transform"
    ...
    <div ref="mapPin" class="relative px-6 pb-28">
      <div
        class="map-container relative w-full max-w-5xl mx-auto will-change-transform"
      >
        <div
